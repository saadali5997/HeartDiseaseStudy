...
Data Details: http://archive.ics.uci.edu/ml/machine-learning-databases/heart-disease/heart-disease.names
...
Lets do a more detailed analysis of our problem. We have another heart disease dataset with 76 featuers. 
...
##### Which model works best with the optimized set of features? Which hypermeters are best for each model we choose? 

These are some of the questions that intrigue us
